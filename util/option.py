...
class BaseOptions(object):
    ...
    def __init__(self):
        ...
        # train opts
        self.parser.add_argument('--max_epoch', default=300, type=int, help='Max epochs')
        self.parser.add_argument('--lr', '--learning-rate', default=0.007, type=float, help='initial learning rate')
        ...
        # data set
        self.parser.add_argument('--net', default='mobilenet', type=str,
                                 choices=['vgg', 'vgg_bn', 'resnet50', 'resnet101', 'Xception', 'deeplab_resnet',
                                          'mobilenet'],
        ...
        # eval args
        self.parser.add_argument('--checkepoch', default=300, type=int, help='Load checkpoint number')  # 110, 220
